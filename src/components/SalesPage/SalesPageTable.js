...
const HistoryPageTable = ({ saleHistory, fetchOrders, userId }) => {
  const classes = useRowStyles();
    ...
    createData(
      ...
      <div>
        ...
        >
          ...
          <MenuItem value="In shipment">En cours de préparation</MenuItem>
          <MenuItem value="dispatched">Expédié</MenuItem>
        </Select>
      </div>
    )
  );
