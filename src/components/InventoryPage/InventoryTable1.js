...
function createData(
  ...
  return { name, cis, expirationDate, pathology, quantity, price, editBtn };
}
...
const headCells = [
  ...
  { id: 'edit', numeric: true, disablePadding: false },
];
...
const InventoryTable = ({ inventoryData }) => {
  ...
  // Fonction qui va permettre de changer de pages dans le tableau
  // après un click
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.cis}</TableCell>
                      <TableCell align="left">{row.expirationDate}</TableCell>
                      <TableCell align="left">{row.pathology}</TableCell>
                      <TableCell align="left">{row.quantity}</TableCell>
                      <TableCell align="left">{row.price}</TableCell>
                      <TableCell align="left">{row.editBtn}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
